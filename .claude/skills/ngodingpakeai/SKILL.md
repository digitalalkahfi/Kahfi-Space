...
- Workspace ID: `1cf9cef1-df75-4147-b045-75411b6a76c7`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/1cf9cef1-df75-4147-b045-75411b6a76c7.
...
2. `npx ngodingpakeai connect --workspace 1cf9cef1-df75-4147-b045-75411b6a76c7 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/1cf9cef1-df75-4147-b045-75411b6a76c7. Only pass on links the CLI actually printed — never assemble one from an id yourself.

  ...
  },
  {
    ...
    baris: [
      ...
      },
      {
        ...
        ubahan: "apa-adanya",
        wajib: true,
        catatan: "Toko yang sama (ejaan berbeda) digabung.",
      },
      {
        medanLama: "name",
        kolomBaru: "nama_kontak",
        ubahan: "apa-adanya",
        wajib: false,
      },
      {
        ...
        ubahan: "apa-adanya",
        wajib: false,
        catatan: "Yang bukan nomor dipindah ke catatan.",
      },
      {
        medanLama: "category",
        kolomBaru: "kategori",
      ...
      },
      {
        ...
        ubahan: "apa-adanya",
        wajib: true,
        catatan: "prospek/aktif.",
      },
      {
        medanLama: "commission",
        kolomBaru: "komisi_persen",
        ubahan: "angka-berpemisah",
        wajib: false,
        catatan: "Teks '10%' → 10.",
      },
      ...
      },
      {
        ...
        ubahan: "cari-id",
        wajib: false,
        catatan: "Pengelola lama menjadi PIC.",
      },
      {
        medanLama: "managerId",
        kolomBaru: "unit_id",
        ubahan: "cari-id",
        wajib: true,
        catatan: "Unit pengelola lama; TAP bila tidak punya unit.",
      },
      {
        medanLama: "managerId",
        kolomBaru: "dibuat_oleh",
    ...
    dibuang: [
      { medanLama: "managerName", alasan: "Nama sudah diwakili id-nya." },
    ],
  },
  {
    kunci: "notes:all",

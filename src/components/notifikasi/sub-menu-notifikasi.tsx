...
/** Dua halaman notifikasi: daftarnya dan pengaturannya. */
const MENU = [
  { href: "/notifikasi", label: "Semua notifikasi" },
  { href: "/notifikasi/preferensi", label: "Preferensi" },
  { href: "/notifikasi/whatsapp", label: "WhatsApp" },
];

export function SubMenuNotifikasi() {
  const pathname = usePathname();
  const persona = useSearchParams().get("persona");

  return (
    <nav
      aria-label="Bagian notifikasi"
